                     ...
                     {showNotifications && (
                        <>
                           ...
                           <motion.div
                              ...
                              className={`fixed md:absolute left-1/2 md:left-auto md:right-0 top-[30%] md:top-full -translate-x-1/2 md:translate-x-0 md:translate-y-0 md:mt-2 w-[90vw] sm:w-96 md:w-96 rounded-3xl shadow-2xl border overflow-hidden z-[101] max-h-[60vh] md:max-h-96 mx-auto ${
